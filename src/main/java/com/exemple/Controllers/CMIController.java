...
public class CMIController {
    ...
    public void VerifierSolde(@Param("solde") double solde){
    ...
    public void VerifierPermission(@Param("user") User user){
    ...
    public void VerifierPayees(@Param("facture") Facture f){
